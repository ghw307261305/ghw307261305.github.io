...
export const ui = {
  ja: {
    ...
    tools: 'ツール・テンプレート', glossary: 'IT用語対照', about: 'About', aboutFull: 'About・依頼できること',
    ...
    author: '運営者', authorName: '加来 直樹', authorRole: 'ITエンジニア / PM · 東京',
    authorBio: 'IT 業界 16 年、日中で 40 件超の案件を担当。教育・金融・製造・物流・不動産・小売。Salesforce・ServiceNow からクラウド設計・構築、AI 導入まで、開発と PM の両面で対応します。',
  ...
  zh: {
    ...
    tools: '工具与模板', glossary: 'IT用语对照', about: '关于我', aboutFull: '关于我 · 可以委托的事',
    ...
    author: '运营者', authorName: '加来直树', authorRole: 'IT工程师 / PM · 东京',
    authorBio: 'IT 行业 16 年，中日两地 40 余个项目。教育、金融、制造、物流、不动产、零售。从 Salesforce、ServiceNow 到云架构、AI 导入，开发与 PM 两种角色都能承担。',
  ...
  en: {
    ...
    tools: 'Tools & Templates', glossary: 'IT Glossary', about: 'About', aboutFull: 'About · What I can help with',
    ...
    author: 'Author', authorName: 'Naoki Kaku', authorRole: 'IT engineer / PM · Tokyo',
    authorBio: '16 years in IT, 40+ projects across Japan and China. Education, finance, manufacturing, logistics, real estate, retail. Salesforce and ServiceNow through to cloud architecture and AI adoption, as both developer and PM.',
