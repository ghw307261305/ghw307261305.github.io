...
export const ui = {
  ja: {
    ...
    author: '運営者', authorName: '郭 華維（カク・カイ）', authorRole: 'ITエンジニア / PM · 東京',
  ...
  zh: {
    ...
    author: '运营者', authorName: '郭华维', authorRole: 'IT工程师 / PM · 东京',
  ...
  en: {
    ...
    author: 'Author', authorName: 'Guo Huawei', authorRole: 'IT engineer / PM · Tokyo',
