...
export const ui = {
  ja: {
    ...
    authorBio: 'IT業界 16 年、日中で 40 件超の案件を担当。金融・保険、物流、CRM、ERP。Salesforce・ServiceNow からクラウド設計・構築まで、開発と PM の両面で対応します。',
  ...
  zh: {
    ...
    authorBio: 'IT 行业 16 年，中日两地 40 余个项目。金融保险、物流、CRM、ERP。从 Salesforce、ServiceNow 到云架构，开发与 PM 两种角色都能承担。',
  ...
  en: {
    ...
    authorBio: '16 years in IT, 40+ projects across Japan and China. Finance & insurance, logistics, CRM, ERP. Salesforce and ServiceNow through to cloud architecture, as both developer and PM.',
