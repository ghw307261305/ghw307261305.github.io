...
export const ui = {
  ja: {
    ...
    author: '運営者', authorName: '[著者名]', authorRole: 'Salesforce 開発者 / PM · 東京',
    authorBio: '日本企業の業務システム案件を、開発とPMの両方の立場で現場で動かしています。中国語ネイティブ、日本語での客先折衝が主戦場。',
  ...
  zh: {
    ...
    author: '运营者', authorName: '[作者名]', authorRole: 'Salesforce 开发者 / PM · 东京',
    authorBio: '以开发者和PM的双重身份，在一线推进日本企业的业务系统项目。中文母语，日常用日语与客户沟通。',
  ...
  en: {
    ...
    author: 'Author', authorName: '[Author name]', authorRole: 'Salesforce developer / PM · Tokyo',
    authorBio: 'I run business-system projects at Japanese companies as both developer and PM. Native Chinese speaker, working in Japanese with clients day to day.',
