...
export const ui = {
  ja: {
    ...
    author: '運営者', authorName: '[著者名]', authorRole: 'ITエンジニア / PM · 東京 · 経験 16 年',
    authorBio: '2010 年から IT 業界、2014 年から日本の現場。金融・保険、物流、CRM、ERP の案件を 40 件以上。Salesforce・ServiceNow からクラウド構築まで。',
  ...
  zh: {
    ...
    author: '运营者', authorName: '[作者名]', authorRole: 'IT工程师 / PM · 东京 · 16 年经验',
    authorBio: '2010 年入行，2014 年起在日本一线。金融保险、物流、CRM、ERP 项目 40 余个。从 Salesforce、ServiceNow 到云平台部署。',
  ...
  en: {
    ...
    author: 'Author', authorName: '[Author name]', authorRole: 'IT engineer / PM · Tokyo · 16 years',
    authorBio: 'In IT since 2010, on-site in Japan since 2014. Over 40 projects across finance & insurance, logistics, CRM and ERP. Salesforce and ServiceNow through to cloud deployment.',
